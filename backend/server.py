...
async def startup():
    ...
    BASELINE_RESOURCES = [
            ...
            {
                "type": "video",
                "title": "Étapes d'une consultation prénatale — MSHP",
                "description": "Que se passe-t-il chez la sage-femme ?",
                "category": "grossesse",
                "video_url": "https://www.youtube.com/watch?v=7l9OFlw8w1g",
                "duration_sec": 300,
                "source": "MSHP-CI",
                "tags": ["video", "consultation", "prenatal"],
            },
            {
                "type": "video",
                "title": "Massage bébé : les bons gestes",
                "description": "Tutoriel pour favoriser sommeil et lien.",
                "category": "soins_bebe",
                "video_url": "https://www.youtube.com/watch?v=QUUjB3rQR9Y",
                "duration_sec": 420,
                "source": "UNICEF",
                "tags": ["video", "bebe", "massage", "lien"],
            },
            {
                "type": "video",
                "title": "Comment changer une couche correctement",
                "description": "Hygiène, prévention érythème, gestes essentiels.",
                "category": "soins_bebe",
                "video_url": "https://www.youtube.com/watch?v=k-eZkbWv8Tw",
                "duration_sec": 180,
                "source": "UNICEF",
                "tags": ["video", "bebe", "couche", "hygiene"],
            },
            {
                "type": "quiz",
            ...
            {
                "type": "video",
                "title": "Respiration & poussées : techniques d'accouchement",
                "description": "Comment respirer pendant les contractions et la poussée.",
                "category": "accouchement",
                "video_url": "https://www.youtube.com/watch?v=DPlncvXqqck",
                "duration_sec": 480,
                "source": "OMS",
                "tags": ["video", "accouchement", "respiration"],
            },
            {
                "type": "quiz",
            ...
            {
                "type": "video",
                "title": "Le portage en pagne : tradition et bien-être",
                "description": "Tutoriel pour porter bébé en sécurité (style ivoirien).",
                "category": "developpement",
                "video_url": "https://www.youtube.com/watch?v=rByM23GaJLI",
                "duration_sec": 360,
                "source": "UNICEF",
                "tags": ["video", "portage", "pagne", "lien"],
            },
            # --- VACCINATION (+3) ---
            {
                "type": "fiche",
            ...
            {
                "type": "video",
                "title": "Le jour de la vaccination de bébé : étapes",
                "description": "Comment se déroule une séance vaccinale au PEV.",
                "category": "vaccination",
                "video_url": "https://www.youtube.com/watch?v=4mBpsPP-zQE",
                "duration_sec": 240,
                "source": "UNICEF",
                "tags": ["video", "vaccination", "pev"],
            },
            # --- ALLAITEMENT (+2) ---
            {
                "type": "fiche",
            ...
            {
                "type": "video",
                "title": "Pose et retrait du stérilet (DIU) — explication",
                "description": "Démystifier la pose du stérilet.",
                "category": "contraception",
                "video_url": "https://www.youtube.com/watch?v=dt_pdKafWwI",
                "duration_sec": 300,
                "source": "OMS",
                "tags": ["video", "contraception", "diu", "sterilet"],
            },
            # --- HYGIENE (NEW — 5) ---
            {
                "type": "fiche",
