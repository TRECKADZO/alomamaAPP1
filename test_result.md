...
agent_communication:
  - agent: "main"
    message: "Phase 3 terminée : 1) Profil refondu avec header gradient selon rôle, avatar large, chip rôle (+ Premium si actif), section 'Mon espace santé' regroupant 8 modules (grossesse, enfants, cycle, documents, sommeil, agenda, famille, premium). 2) Communauté refondue avec header gradient amber-orange, 3 stats (Discussions/Membres/Aujourd'hui), barre de recherche, 9 chips de catégories colorés, badge PRO pour les professionnels, likes+commentaires. 3) Nouvelles routes : /agenda (calendrier mensuel + événements à venir), /sommeil (suivi qualité+heures avec AsyncStorage), /documents (stockage AsyncStorage+photos base64, 6 catégories)."
  - agent: "main"
